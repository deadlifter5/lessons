...
let decreasePriceCount = dataList.reduce((prevCount, productPrice) => {
  if (productPrice.price < productPrice.old_price) prevCount++

  return prevCount
}, 0)
console.log(`2. Products with decreased price: ${decreasePriceCount}`)

// ============================================================================
// 3.Товари, які доступні (sell_status:"available")
function availableProduct() {
  return dataList.filter((product) => product.sell_status === "available")
}
console.log("3.")
